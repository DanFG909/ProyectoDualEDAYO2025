...
class GenerarPDF {
    ...
    private function obtenerDatos() {
        $sql = "SELECT id, CURP, Nombre, Correo, Telefono, Periodo, Modalidad, Forma_de_Pago FROM inscripciones";
    ...
    public function crearPDF() {
        ...
        if (empty($rows)) {
            ...
            foreach ($rows as $r) {
                $html .= '<tr>
                    <td>' . (int)$r['id'] . '</td>
                    <td>' . htmlspecialchars($r['CURP'], ENT_QUOTES, 'UTF-8') . '</td>
                    ...
                    <td>' . htmlspecialchars($r['Periodo'], ENT_QUOTES, 'UTF-8') . '</td>
                    <td>' . htmlspecialchars($r['Modalidad'], ENT_QUOTES, 'UTF-8') . '</td>
                    <td>' . htmlspecialchars($r['Forma_de_Pago'], ENT_QUOTES, 'UTF-8') . '</td>
                </tr>';
            }
        }
